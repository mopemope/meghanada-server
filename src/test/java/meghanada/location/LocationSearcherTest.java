...
public class LocationSearcherTest extends GradleTestBase {
    ...
    public void testJumpVariable01() throws Exception {
        ...
        Location result = timeIt(() ->
                searcher.searchDeclarationLocation(f, 76, 16, "result"))
                .orElse(null);
    ...
    public void testJumpParamVariable01() throws Exception {
        ...
        Location result = timeIt(() ->
                ...
                .orElse(null);
        assertNotNull(result);
        assertEquals(81, result.getLine());
    ...
    public void testJumpField01() throws Exception {
        ...
        Location result = timeIt(() ->
                searcher.searchDeclarationLocation(f, 240, 14, "currentProject"))
                .orElse(null);
        assertNotNull(result);
        assertEquals(54, result.getLine());
    ...
    public void testJumpMethod01() throws Exception {
        ...
        LocationSearcher searcher = getSearcher();
        Location result = timeIt(() ->
                searcher.searchDeclarationLocation(f, 410, 14, "parseJavaSource"))
                .orElse(null);

        assertNotNull(result);
        assertEquals(462, result.getLine());
    ...
    public void testJumpMethod02() throws Exception {
        ...
        Location result = searcher.searchDeclarationLocation(f, 458, 49, "searchMissingImport")
                .orElse(null);
        assertNotNull(result);
        assertTrue(result.getPath().contains("Source.java"));
        assertEquals(304, result.getLine());
    ...
    public void testJumpMethod05() throws Exception {
        ...
        LocationSearcher searcher = getSearcher();
        Location result = timeIt(() ->
                searcher.searchDeclarationLocation(f, 213, 24, "searchField"))
                .orElse(null);
        assertNotNull(result);
    ...
    public void testJumpMethod06() throws Exception {
        ...
        Location result = timeIt(() -> {
            ...
            return searcher.searchDeclarationLocation(f, 426, 76, "decompileArchive");
        }).orElse(null);
        assertNotNull(result);
        assertTrue(result.getPath().contains(".java"));
